...
public class RunAtStart {
	...
	public void runAtStart() {
		...
		Publication publication = new Publication.Builder()
				...
				.language("polski")
				.publisher("wydawca")
				.placeOfPublication("Opole")
				.resourceIdentifier("s")
				.year(2000)
				.build();
		Publication publication2 = new Publication.Builder()
				.title("Tytuł2")
				.descryption("opis")
				.listOfAuthors(listOfAuthors2)
				.language("polski")
				.publisher("wydawca")
				.placeOfPublication("Opole")
				.resourceIdentifier("s")
		...
		Author author = new Author.Builder()
				.firstName("Karol")
				.lastName("Wiśniewski")
				.dateOfBirthOfTheAuthor(LocalDate.of(1911, 12, 12))
				.dateOfDeathOfTheAuthor(LocalDate.of(1991, 11, 11))
		...
		Author author2 = new Author.Builder()
				.firstName("Magdalena")
				.lastName("Malinowska")
				.dateOfBirthOfTheAuthor(LocalDate.of(1984, 12, 12))
				.listOfPublications(listOfPublications)
				.build();
		...
		Author author3 = new Author.Builder()
				.firstName("Henryk")
				.lastName("Kowalski")
				.dateOfBirthOfTheAuthor(LocalDate.of(1980, 12, 12))
				.listOfPublications(listOfPublications2)
				.build();
		
		Author author4 = new Author.Builder()
				.firstName("Jan")
				.lastName("Nowak")
				.dateOfBirthOfTheAuthor(LocalDate.of(1911, 12, 12))
				.dateOfDeathOfTheAuthor(LocalDate.of(1991, 11, 11))
